<script>
//防剽窃js-点击支付按钮后不进行任何操作-隐秘写法
  // 1. 域名检查
  if (!window.location.hostname.includes(atob('bWF3b25kZXJmdWw='))) {//隐秘写法：mawonderful 的Base64编码，然后解码后取完整字符串
    ...
    function blockPayment(e) {
      ...
      const encoded = 'aHR0cHM6Ly93d3cubWF3b25kZXJmdWwuY29t'; //隐秘写法：https://www.mawonderful.com 的Base64编码，然后解码后取完整字符串
      window.location.href = atob(encoded); // 运行时解码
